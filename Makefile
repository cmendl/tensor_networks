...
# test files
TSTFILES = test/matrix_exp_test.c test/tensor_test.c test/lanczos_test.c test/qnumber_test.c test/qnumber_test2.c test/bond_ops_test.c test/mps_test.c test/mpo_test.c test/operation_test.c test/hamiltonian_heisenberg_test.c test/hamiltonian_heisenberg_spin1_test.c test/hamiltonian_ising_test.c test/hamiltonian_bose_hubbard_test.c test/hamiltonian_fermi_hubbard_test.c test/minimization_test.c test/dynamics_test.c test/peps_test.c test/peps_test2.c
