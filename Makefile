...
TSTFILES = qnumber_test.o matrix_exp_test.o bond_ops_test.o mps_test.o mpo_test.o operation_test.o lanczos_test.o hamiltonian_heisenberg_test.o hamiltonian_ising_test.o hamiltonian_bose_hubbard_test.o hamiltonian_fermi_hubbard_test.o minimization_test.o dynamics_test.o peps_test.o peps_test2.o tensor_test.o
