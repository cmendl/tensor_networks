...
int main()
{
	...
	test_function_t tests[] = { MatrixExpTest, TensorTest, MPSTest, MPOTest, OperationTest, HamiltonianHeisenbergTest, HamiltonianBoseHubbardTest, DynamicsTest, PEPSTest, PEPSTest2 };
